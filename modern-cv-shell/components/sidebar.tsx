      ...
      <div className="p-4 lg:p-6">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            <div>
              <p className="text-xs lg:text-sm mb-1">Python/JavaScript [████████░░] 80%</p>
            </div>
            <div>
              <p className="text-xs lg:text-sm mb-1">OTT/IPTV Control [███████░░░] 75%</p>
            </div>
            <div>
              <p className="text-xs lg:text-sm mb-1">Incident Management [███████░░░] 70%</p>
            </div>
          </div>
        </div>
